...
class ewriter():
    def __init__(self):
        self.model = ChatOpenAI(model="step-1-32k", temperature=0.2)
    ...
    def create_interface(self):
        with gr.Blocks(theme=gr.themes.Default(spacing_size='sm', text_size="sm")) as demo:
            ...
            with gr.Tab("StateSnapShots"):
                ...
                graph_image = Image.open(io.BytesIO(self.graph.get_graph().draw_png()))
                gr.Image(height=graph_image.height, width=graph_image.width)
        return demo
